...
Funzionalit� non ancora implementate o limitazioni:
- Fasce orarie, giorni della settimana, calendari
- Per il momento conviene tenere i canali locbus "separati" e non misti (ovvero, evitare di mettere KX100 e KX50 sullo stesso locbus)
	Questo perch� KX50, non essendo un'elettronica Cortex, � limitato ad un baudrate di 9600
	Esempio: 	canale locbus 1 (/dev/ttys1) "Kleis" baudrate: 9600 (perch� contiene dei KX50)
			canale locbus 2 (/dev/ttys2) "RoomController" baudrate: 38400 (perch� NON contiene dei KX50)
